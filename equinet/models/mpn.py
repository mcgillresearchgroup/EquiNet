...
from equinet.features import BatchMolGraph, get_atom_fdim, get_bond_fdim, mol2graph
from equinet.nn_utils import index_select_ND, get_activation_function
...
class MPNEncoder(nn.Module):
    ...
    def __init__(self, args: TrainArgs, atom_fdim: int, bond_fdim: int, hidden_size: int = None,
        ...
        """
        :param args: A :class:`~equinet.args.TrainArgs` object containing model arguments.
    ...
    def forward(self,
        ...
        :param mol_graph: A :class:`~equinet.features.featurization.BatchMolGraph` representing
...
class MPN(nn.Module):
    ...
    def forward(self,
        ...
        :param batch: A list of list of SMILES, a list of list of RDKit molecules, or a
                      list of :class:`~equinet.features.featurization.BatchMolGraph`.

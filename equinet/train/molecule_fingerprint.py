...
from equinet.args import FingerprintArgs, TrainArgs
from equinet.data import get_data, get_data_from_smiles, MoleculeDataLoader, MoleculeDataset
from equinet.utils import load_args, load_checkpoint, makedirs, timeit, load_scalers, update_prediction_args
from equinet.data import MoleculeDataLoader, MoleculeDataset
from equinet.features import set_reaction, set_explicit_h, set_adding_hs, set_keeping_atom_map, reset_featurization_parameters, set_extra_atom_fdim, set_extra_bond_fdim
...
def equinet_fingerprint() -> None:
    """
    Parses EquiNet predicting arguments and returns the latent representation vectors for

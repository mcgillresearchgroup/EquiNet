...
from equinet.constants import TEST_SCORES_FILE_NAME, TRAIN_LOGGER_NAME
from equinet.data import get_data, get_task_names, MoleculeDataset, validate_dataset_type
from equinet.utils import create_logger, makedirs, timeit, multitask_mean
from equinet.features import set_extra_atom_fdim, set_extra_bond_fdim, set_explicit_h, set_adding_hs, set_keeping_atom_map, set_reaction, reset_featurization_parameters
...
def equinet_train() -> None:
    """Parses EquiNet training arguments and trains (cross-validates) a EquiNet model.

    This is the entry point for the command line command :code:`equinet_train`.
    """
